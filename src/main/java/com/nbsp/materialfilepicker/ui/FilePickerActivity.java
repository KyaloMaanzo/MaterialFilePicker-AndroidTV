...
public class FilePickerActivity extends Activity implements DirectoryFragment.FileClickListener {
    ...
    private void initToolbar() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(mTitle)) {
                f = getActionBar().getClass().getDeclaredField("mTitleTextView");
            } else {
                f = getActionBar().getClass().getDeclaredField("mSubtitleTextView");
            }

            f.setAccessible(true);
            TextView textView = (TextView) f.get(getActionBar());
    ...
    private void updateTitle() {
        if (getActionBar() != null) {
            ...
            if (TextUtils.isEmpty(mTitle)) {
                getActionBar().setTitle(titlePath);
            } else {
                getActionBar().setSubtitle(titlePath);
            }
        }
    }
